...
class registration():
    ...
    def Signup(self):
       ...
       # =========== Back button ==================================================
        ...
        self.show_button = Button(self.lgn_frame, image=self.show_image, command=self.showw, relief=FLAT,
                                  activebackground="white"
                                  , borderwidth=0, background="white", cursor="hand2")
        self.show_button.place(x=860, y=420)

    def showw(self):
        self.hide_button = Button(self.lgn_frame, image=self.hide_image, command=self.hidee, relief=FLAT,
                                  activebackground="white"
                                  , borderwidth=0, background="white", cursor="hand2")
